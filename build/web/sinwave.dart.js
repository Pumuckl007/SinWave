...
["dart.async", "dart:async", , P, {
  ...
  _SyncCompleter: {
    ...
    }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 48, 16, 17, 18]
  },
  _Future: {
  ...
  _ForwardingStreamSubscription: {
    ...
    }, "call$2", "get$_handleError", 4, 0, 55, 17, 18],
...
["dart.dom.html", "dart:html", , W, {
  ...
  EventTarget: {
    ...
    $isEventTarget: true,
    "%": "ApplicationCache|AudioContext|DOMApplicationCache|EventSource|MIDIAccess|MediaController|MediaSource|MessagePort|Notification|OfflineAudioContext|OfflineResourceList|Performance|RTCDTMFSender|RTCPeerConnection|SpeechRecognition|SpeechSynthesis|SpeechSynthesisUtterance|WebKitMediaSource|WebKitNotification|WebKitSourceBufferList|mozRTCPeerConnection|webkitAudioContext;EventTarget;EventTarget_ListMixin|EventTarget_ListMixin_ImmutableListMixin|EventTarget_ListMixin0|EventTarget_ListMixin_ImmutableListMixin0"
  },
  FieldSetElement: {
...
["dart.dom.indexed_db", "dart:indexed_db", , P, {
  ...
  Cursor: {
    ...
    }, "next$0", "call$1", "call$0", "get$next", 0, 2, 32, 16],
    "%": ";IDBCursor"
  },
  CursorWithValue: {
    "^": "Cursor;",
  ...
  Index: {
    ...
    }, "count$0", "call$1", "call$0", "get$count", 0, 2, 33, 16, 34],
    "%": "IDBIndex"
  },
  KeyRange: {
    "^": "Interceptor;",
  ...
  _completeRequest_closure: {
    "^": "Closure:29;request_0,completer_1",
    call$1: [function(e) {
      var t1, t2;
...
["dart.dom.web_gl", "dart:web_gl", , P, {
  ...
  RenderingContext: {
    ...
    }, "call$1", "get$blendEquation", 2, 0, 36, 37],
    ...
    }, "call$2", "get$polygonOffset", 4, 0, 38, 39, 40],
...
["", "sinwave.dart", , F, {
  "^": "",
  main: [function() {
    var el1, heightandwidth, x, y, t1, t2, t3, cube1;
    el1 = document.querySelector("#stage1");
    heightandwidth = P.JsObject_JsObject(J.$index$asx($.get$context(), "height"), []);
    x = heightandwidth.callMethod$2("height", []);
    y = heightandwidth.callMethod$2("width", []);
    t1 = new T.Vector3(new Float32Array(3));
    t1.setValues$3(0, 0, 0);
    t2 = H.setRuntimeTypeInfo([], [F.Part]);
    t3 = $.MaterialCount;
    $.MaterialCount = t3 + 1;
    cube1 = new F.Cube(null, null, null, null, y, x, 0, 2000, false, 0.01, 0.02, 0, 0, 0, t1, null, t2, new S.MeshBasicMaterial(null, null, null, null, 0, 1, 0.98, 2, false, 1, "round", "round", false, false, false, 0, 0, "", t3, 0, S.Color$(3407871), 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, true, 0, null, null, null, null, null, false));
    cube1.Cube$5(el1, y, x, 16711680, 0.025);
    cube1.draw$1(0);
  }, "call$0", "main$closure", 0, 0, 12],
  Cube: {
    "^": "Object;scene,render@,shape,cam,width>,height>,time,maxtime,paused,rspeed,speed,x>,thetaDelta,phiDelta,offset,controls,parts,mat",
    render$4: function(arg0, arg1, arg2, arg3) {
      return this.render.call$4(arg0, arg1, arg2, arg3);
    },
    draw$1: function(time) {
      var t1, t2, t3, t4, m, removed, i, part, t5, ri;
      this.time += 0.1;
      t1 = this.speed;
      t2 = this.x + t1;
      this.x = t2;
      this.cam.position.setValues$3(t2 + 80, 0, 60);
      t2 = this.cam;
      t3 = this.x;
      t4 = new T.Vector3(new Float32Array(3));
      t4.setValues$3(t3, -2, 0);
      t2.lookAt$1(t4);
      t2 = !this.paused;
      if (t2 && C.JSInt_methods.$mod(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(this.time * 1000)), 500) === 0) {
        m = S.Mesh$(S.SphereGeometry$(0.05, 8, 6, 0, 6.283185307179586, 0, 3.141592653589793), this.mat);
        t3 = m.position;
        t4 = this.time;
        t3 = t3.storage;
        t3[0] = t4 * t1 * 10;
        t3[1] = (Math.sin(t4 / 10) - 0.5) * 4;
        this.scene.add$1(0, m);
        t1 = new F.Part(null, 0);
        t1.mesh = m;
        this.parts.push(t1);
      }
      this.render.render$2(this.scene, this.cam);
      this.render.setClearColorHex$2(131586, 1);
      t1 = window;
      C.Window_methods._ensureRequestAnimationFrame$0(t1);
      C.Window_methods._requestAnimationFrame$1(t1, W._wrapZone(new F.Cube_draw_closure(this)));
      removed = H.setRuntimeTypeInfo([], [F.Part]);
      t1 = this.parts;
      i = new H.ListIterator(t1, t1.length, 0, null);
      for (t3 = this.maxtime; i.moveNext$0();) {
        part = i._current;
        if (part != null) {
          if (part.get$timealive() > t3) {
            removed.push(part);
            this.scene.remove$1(0, part.get$mesh());
          } else {
            t4 = part.get$mesh();
            ...
            t5[1] = 0.998;
            t5[2] = 0.998;
            t4.scale.multiply$1(0, new T.Vector3(t5));
          }
          if (t2)
            part.set$timealive(part.get$timealive() + 1);
        }
      }
      ri = new H.ListIterator(removed, removed.length, 0, null);
      for (; ri.moveNext$0();)
        C.JSArray_methods.remove$1(t1, ri._current);
    },
    Cube$5: function(c, width, height, color, speed) {
      ...
      t2 = this.width;
      t3 = this.height;
      J.set$width$x(t1.canvas, J.toInt$0$n(J.$mul$ns(t2, t1.devicePixelRatio)));
      J.set$height$x(t1.canvas, J.toInt$0$n(J.$mul$ns(t3, t1.devicePixelRatio)));
      J.set$width$x(t1.canvas.style, H.S(t2) + "px");
      J.set$height$x(t1.canvas.style, H.S(t3) + "px");
      ...
      this.render = t1;
      c.appendChild(t1.get$domElement());
      ...
      t1 = new S.PerspectiveCamera(8, t1, null, null, null, null, null, null, t4, t5, t6, 1, 1000, t2, t3, t7, "", t8, null, [], t9, t10, t11, t12, "XYZ", null, null, null, true, null, t13, t14, t15, true, true, t16, false, 0, 1, true, false, false, true, new T.Vector3(new Float32Array(3)), null, null, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
      t1.updateProjectionMatrix$0();
      t1.position.setValues$3(-1, -2, 60);
      this.cam = t1;
      t1 = $.Object3DCount;
      $.Object3DCount = t1 + 1;
      ...
      t1 = new S.Scene(null, null, null, null, null, null, null, null, null, null, t1, "", t2, null, [], t3, t4, t5, t6, "XYZ", null, null, null, true, null, t7, t8, t9, true, true, t10, false, 0, 1, true, false, false, true, new T.Vector3(new Float32Array(3)), null, null, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
      t1.Scene$0();
      t1.add$1(0, this.cam);
      this.scene = t1;
    }
  ...
  Cube_draw_closure: {
    "^": "Closure:29;this_0",
    call$1: [function(t) {
      return this.this_0.draw$1(t);
    }, "call$1", null, 2, 0, null, 62, "call"],
    $isFunction: true
  },
  Part: {
    "^": "Object;mesh<,timealive@"
  }
},
1],
["three", "package:three/three.dart", , S, {
  ...
  decompose: function(m, translation, rotation, scale) {
    ...
    translation.set$x(0, te[12]);
    if (13 >= t1)
      return H.ioore(te, 13);
    translation.set$y(0, te[13]);
    if (14 >= t1)
      return H.ioore(te, 14);
    translation.set$z(0, te[14]);
    matrix = m.clone$0(0);
    t1 = matrix.get$storage();
    if (0 >= t1.length)
      return H.ioore(t1, 0);
    t1[0] = t1[0] / t2[0];
    t1 = matrix.get$storage();
  ...
  SphereGeometry: {
    ...
    SphereGeometry$7: function(radius, segmentsWidth, segmentsHeight, phiStart, phiLength, thetaStart, thetaLength) {
      ...
      for (t1 = this.radius, y = 0; y <= segmentsY; ++y) {
        ...
        for (x = 0; x <= segmentsX; ++x) {
          ...
          this.vertices.push(new T.Vector3(t2));
      ...
      for (t2 = this.faceVertexUvs, y = 0; y < segmentsY; y = y0)
        for (y0 = y + 1, x = 0; x < segmentsX; x = x0) {
          ...
          if (v1 < 0 || v1 >= t3.length)
            return H.ioore(t3, v1);
          n1 = J.normalize$0$x(J.clone$0$x(t3[v1]));
          t3 = this.vertices;
          if (v2 < 0 || v2 >= t3.length)
            return H.ioore(t3, v2);
          n2 = J.normalize$0$x(J.clone$0$x(t3[v2]));
          t3 = this.vertices;
          if (v3 < 0 || v3 >= t3.length)
            return H.ioore(t3, v3);
          n3 = J.normalize$0$x(J.clone$0$x(t3[v3]));
          t3 = this.vertices;
          if (v4 < 0 || v4 >= t3.length)
            return H.ioore(t3, v4);
          n4 = J.normalize$0$x(J.clone$0$x(t3[v4]));
          t3 = uvs.length;
          if (y >= t3)
          ...
          if (v1 >= t3.length)
            return H.ioore(t3, v1);
          if (J.abs$0$n(J.get$y$x(t3[v1])) === t1) {
            t3 = this.faces;
            t4 = [v1, v3, v4];
    ...
    static: {SphereGeometry$: function(radius, segmentsWidth, segmentsHeight, phiStart, phiLength, thetaStart, thetaLength) {
        var t1 = new S.SphereGeometry(radius, "", H.setRuntimeTypeInfo([], [T.Vector3]), [], [], [], [], [[]], [[]], [], [], [], [], [], [], null, null, null, false, false, null, null, false, false, false, false, false, false, false, false, false, null, null, null, null, null, null, null, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
        t1.Geometry$0();
  ...
  CameraHelper: {
    ...
    addPoint$2: function(id, hex) {
      var t1 = this.geometry.vertices;
      t1.push(new T.Vector3(new Float32Array(3)));
  ...
  ShadowMapPlugin: {
    ...
    update$2: function(_, scene, camera) {
      ...
      for (t1 = J.getInterceptor$ax(camera), i = 0, n = null, virtualLight = null; i < il; ++i) {
        ...
        if (!!t2.$isDirectionalLight && light.shadowCascade)
          for (n = 0; n < light.get$shadowCascadeCount(); ++n) {
            ...
            t18[3] = 1;
            gyro = new S.Gyroscope(new T.Vector3(t3), new T.Vector3(t4), new T.Quaternion(t5), new T.Quaternion(t6), new T.Vector3(t7), new T.Vector3(t8), t9, "", t10, null, [], new T.Vector3(t11), new T.Vector3(t12), new T.Vector3(t13), new T.Vector3(t14), "XYZ", null, null, null, true, null, t15, t16, t17, true, true, new T.Quaternion(t18), false, 0, 1, true, false, false, true, new T.Vector3(new Float32Array(3)), null, null, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            ...
            S.makeLookAt(t3, virtualLight0.target, virtualLight0.three$DirectionalLight$position, virtualLight0.up);
      ...
      il = lights.length;
      for (t1 = this._frustum, t2 = J.getInterceptor$ax(scene), i = 0, j = null, jl = null, shadowMap = null, shadowMatrix = null, shadowCamera = null, buffer = null, material = null, webglObject = null, object = null, renderList = null; i < il; ++i) {
        if (i >= lights.length)
          return H.ioore(lights, i);
        light = lights[i];
        if (light.get$shadowMap() == null) {
          shadowFilter = this._renderer.shadowMapType === 2 ? 3 : 6;
          t3 = new S.WebGLRenderTarget(light.get$shadowMapWidth(), light.get$shadowMapHeight(), null, null, true, true, true, null, null, null, null, null, null, 1, 1, shadowFilter, shadowFilter, 18, 10, 1, null, null, null, null, null, null, null, 4, [], null, null);
          t3.Texture$9(null, null, 1, 1, shadowFilter, shadowFilter, 18, 10, 1);
          if (t3.three$WebGLRenderTarget$offset == null)
            t3.three$WebGLRenderTarget$offset = new T.Vector2(new Float32Array(2));
          if (t3.three$WebGLRenderTarget$repeat == null) {
            t4 = new Float32Array(2);
            t4[0] = 1;
            t4[1] = 1;
            t3.three$WebGLRenderTarget$repeat = new T.Vector2(t4);
          }
          ...
          t5[0] = t3;
          t5[1] = t4;
          light.set$shadowMapSize(new T.Vector2(t5));
          t3 = new T.Matrix4(new Float32Array(16));
          t3.setIdentity$0();
          light.set$shadowMatrix(t3);
        }
        if (light.get$shadowCamera() == null) {
          if (!!J.getInterceptor(light).$isDirectionalLight) {
            ...
            t21.setIdentity$0();
            t22 = new T.Matrix4(new Float32Array(16));
            t22.setIdentity$0();
            t23 = new Float32Array(4);
            t23[3] = 1;
            t24 = new Float32Array(3);
            T.setOrthographicMatrix(t12, t3, t4, t6, t5, t7, t8);
            light.shadowCamera = new S.OrthographicCamera(t3, t4, t5, t6, t11, t12, t13, t7, t8, t9, t10, t14, "", t15, null, [], new T.Vector3(t16), new T.Vector3(t17), new T.Vector3(t18), new T.Vector3(t19), "XYZ", null, null, null, true, null, t20, t21, t22, true, true, new T.Quaternion(t23), false, 0, 1, true, false, false, true, new T.Vector3(t24), null, null, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
          } else {
            H.printString("Unsupported light type for shadow");
            continue;
          }
          t2.add$1(scene, light.get$shadowCamera());
        ...
        if (light.get$shadowCameraVisible() && light.get$cameraHelper() == null) {
          ...
          t7.setHex$1(16777215);
          t6 = new S.LineBasicMaterial(1, "round", "round", "", t6, 0, t7, 1, 1, 204, 205, 100, 0, false, 0, 0, false, true, true, false, true, true, true, 1, null, null, null, null, null, false);
          t7 = $.Object3DCount;
          $.Object3DCount = t7 + 1;
          t8 = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
        ...
        shadowMatrix.multiply$1(0, t3);
        t4 = shadowCamera.projectionMatrix.$mul(0, t3);
        this._projScreenMatrix = t4;
        t1.setFromMatrix$1(t4);
        this._renderer.setRenderTarget$1(shadowMap);
        this._renderer.clear$0(0);
        renderList = scene.get$__webglObjects();
        ...
        for (j = 0; j < jl; ++j) {
          ...
          if (t4.get$visible(object) && object.get$castShadow()) {
            if (!!t4.$isMesh)
              t4 = !object.frustumCulled || t1.contains$1(0, object);
            else
              t4 = true;
            if (t4) {
              object.set$_modelViewMatrix(t3.$mul(0, object.get$matrixWorld()));
        ...
        renderList = scene.get$__webglObjectsImmediate();
        jl = renderList.length;
        for (j = 0; j < jl; ++j) {
          if (j >= renderList.length)
            return H.ioore(renderList, j);
          webglObject = renderList[j];
          object = webglObject.get$object();
          if (J.get$visible$x(object) && object.get$castShadow()) {
            object.get$_modelViewMatrix().multiply$1(0, t3);
  ...
  Camera: {
    ...
    static: {Camera$: function(near, far) {
        ...
        return new S.Camera(t3, t4, t5, near, far, t1, t2, t6, "", t7, null, [], t8, t9, t10, t11, "XYZ", null, null, null, true, null, t12, t13, t14, true, true, t15, false, 0, 1, true, false, false, true, new T.Vector3(new Float32Array(3)), null, null, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
      }}
  },
  OrthographicCamera: {
  ...
  PerspectiveCamera: {
    ...
    updateProjectionMatrix$0: function() {
      ...
      width = height * J.toDouble$0$n(this.aspect);
  ...
  Object_WebGLGeometry: {
    "^": "Object+WebGLGeometry;id:three$WebGLGeometry$id*,faces3:three$WebGLGeometry$faces3<,faces4:three$WebGLGeometry$faces4<,numMorphTargets:three$WebGLGeometry$numMorphTargets<,numMorphNormals:three$WebGLGeometry$numMorphNormals<,geometryGroups:three$WebGLGeometry$geometryGroups@,geometryGroupsList:three$WebGLGeometry$geometryGroupsList@,__webglVertexBuffer:three$WebGLGeometry$__webglVertexBuffer@,__webglNormalBuffer:three$WebGLGeometry$__webglNormalBuffer@,__webglTangentBuffer:three$WebGLGeometry$__webglTangentBuffer@,__webglColorBuffer:three$WebGLGeometry$__webglColorBuffer@,__webglLineDistanceBuffer:three$WebGLGeometry$__webglLineDistanceBuffer@,__webglUVBuffer:three$WebGLGeometry$__webglUVBuffer@,__webglUV2Buffer:three$WebGLGeometry$__webglUV2Buffer@,__webglSkinIndicesBuffer:three$WebGLGeometry$__webglSkinIndicesBuffer@,__webglSkinWeightsBuffer:three$WebGLGeometry$__webglSkinWeightsBuffer@,__webglFaceBuffer:three$WebGLGeometry$__webglFaceBuffer@,__webglLineBuffer:three$WebGLGeometry$__webglLineBuffer@,__webglMorphTargetsBuffers:three$WebGLGeometry$__webglMorphTargetsBuffers@,__webglMorphNormalsBuffers:three$WebGLGeometry$__webglMorphNormalsBuffers@,__webglInit:three$WebGLGeometry$__webglInit@,__inittedArrays:three$WebGLGeometry$__inittedArrays@,__vertexArray:three$WebGLGeometry$__vertexArray@,__normalArray:three$WebGLGeometry$__normalArray@,__tangentArray:three$WebGLGeometry$__tangentArray@,__colorArray:three$WebGLGeometry$__colorArray@,__lineDistanceArray:three$WebGLGeometry$__lineDistanceArray@,__uvArray:three$WebGLGeometry$__uvArray@,__uv2Array:three$WebGLGeometry$__uv2Array@,__skinIndexArray:three$WebGLGeometry$__skinIndexArray@,__skinWeightArray:three$WebGLGeometry$__skinWeightArray@,__faceArray:three$WebGLGeometry$__faceArray@,__lineArray:three$WebGLGeometry$__lineArray@,__morphTargetsArrays:three$WebGLGeometry$__morphTargetsArrays@,__morphNormalsArrays:three$WebGLGeometry$__morphNormalsArrays@,__webglFaceCount:three$WebGLGeometry$__webglFaceCount@,__webglLineCount:three$WebGLGeometry$__webglLineCount@,__webglCustomAttributesList:three$WebGLGeometry$__webglCustomAttributesList<"
  },
  Geometry_computeCentroids_closure: {
    "^": "Closure:66;this_0",
    call$1: function(face) {
      face.get$centroid().setValues$3(0, 0, 0);
      H.IterableMixinWorkaround_forEach(face.get$indices(), new S.Geometry_computeCentroids__closure(this.this_0, face));
      face.set$centroid(face.get$centroid().$div(0, J.toDouble$0$n(J.get$size$x(face))));
    },
    $isFunction: true
  },
  Geometry_computeCentroids__closure: {
    "^": "Closure:29;this_1,face_2",
    call$1: function(idx) {
      var t1, t2;
      t1 = this.face_2.get$centroid();
  ...
  Object3D: {
    ...
    add$1: function(_, object) {
      ...
      if (t1.get$parent(object) != null)
        t1.get$parent(object).remove$1(0, object);
    ...
    static: {"^": "Object3D____m1", Object3D$: function() {
        ...
        t9.setIdentity$0();
        t10 = T.Quaternion$identity();
        return new S.Object3D(t1, "", t2, null, [], t3, t4, t5, t6, "XYZ", null, null, null, true, null, t7, t8, t9, true, true, t10, false, 0, 1, true, false, false, true, new T.Vector3(new Float32Array(3)), null, null, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
      }}
  },
  ...
  DirectionalLight: {
    "^": "ShadowCaster;position:three$DirectionalLight$position>,target>,intensity<,distance<,shadowCascadeOffset<,shadowCascadeCount<,shadowCascadeBias<,shadowCascadeNearZ<,shadowCascadeFarZ<,shadowCascadeArray<",
  ...
  Material: {
    "^": "Object;name>,id*,side<,color>,opacity>,blending<,blendSrc<,blendDst<,blendEquation>,alphaTest<,polygonOffset>,polygonOffsetFactor<,polygonOffsetUnits<,transparent@,depthTest<,depthWrite<,visible>,needsUpdate@,fog<,vertexColors<,_program@,_fragmentShader@,_vertexShader@,_uniforms@,_uniformsList@,shadowPass<"
  },
  MeshBasicMaterial: {
  ...
  Line: {
    "^": "Object3D;material:three$Line$material<,type>",
  ...
  Mesh: {
    ...
    static: {Mesh$: function(geometry, material) {
        ...
        t9.setIdentity$0();
        t10 = T.Quaternion$identity();
        t1 = new S.Mesh(material, 0, null, null, null, t1, "", t2, null, [], t3, t4, t5, t6, "XYZ", null, null, null, true, null, t7, t8, t9, true, true, t10, false, 0, 1, true, false, false, true, new T.Vector3(new Float32Array(3)), null, null, null, false, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  ...
  WebGLRenderer: {
    ...
    deallocateMaterial$1: function(material) {
      var il, i;
      if (material.get$_program() == null)
        return;
      material.set$_program(null);
    ...
    initMeshBuffers$2: function(geometryGroup, object) {
      var geometry, faces3, faces4, t1, t2, nvertices, material, uvType, normalType, t3, t4, ml, m;
      ...
      t4 = object.geometry;
      if (t4.skinWeights.length !== 0 && t4.skinIndices.length !== 0) {
        t4 = nvertices * 4;
        geometryGroup.set$__skinIndexArray(new Float32Array(t4));
        geometryGroup.set$__skinWeightArray(new Float32Array(t4));
      }
      t1 = (t1 + t2 * 2) * 3;
    ...
    bufferGuessNormalType$1: function(material) {
      var t1;
      if (!!J.getInterceptor(material).$isMeshBasicMaterial && true || false)
        return 0;
      if (material != null) {
    ...
    bufferGuessUVType$1: function(material) {
      var t1 = J.getInterceptor(material);
      if (!!t1.$isTextureMapping)
        ;
    ...
    setLineBuffers$2: function(geometry, hint) {
      var vertices, colors, lineDistances, vl, cl, vertexArray, colorArray, lineDistanceArray, dirtyVertices, dirtyColors, dirtyLineDistances, customAttributes, v, offset, vertex, t1, t2, t3, t4, c, color, d, il, i, ca, cal, value, customAttribute;
          ...
          if (t1) {
            ...
            if (t1.get$size(customAttribute) === 1) {
              ...
              for (; ca < cal; ++ca) {
                ...
                customAttribute.get$array().$indexSet(0, offset + 1, t2.get$y(value));
                customAttribute.get$array().$indexSet(0, offset + 2, t2.get$z(value));
                customAttribute.get$array().$indexSet(0, offset + 3, value.get$w());
                offset += 4;
              }
            } else
              offset = 0;
    ...
    setMeshBuffers$5: function(geometryGroup, object, hint, dispose, material) {
      var normalType, uvType, needsSmoothNormals, vertexArray, uvArray, uv2Array, normalArray, tangentArray, colorArray, skinIndexArray, skinWeightArray, morphTargetsArrays, morphNormalsArrays, customAttributes, faceArray, lineArray, geometry, dirtyVertices, dirtyElements, dirtyUvs, dirtyNormals, dirtyTangents, dirtyColors, dirtyMorphTargets, vertices, chunk_faces3, chunk_faces4, obj_faces, t1, obj_uvs, obj_skinIndices, obj_skinWeights, morphTargets, morphNormals, fl, f, face, v1, v2, v3, offset, t2, t3, t4, v4, vkl, n1, n2, n3, n4, vk, vka, nka, chf, faceVertexNormals, offset_morphTarget, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, offset_skin, sw1, sw2, sw3, si1, si2, si3, sw4, t15, t16, t17, t18, si4, offset_color, vertexColors, faceColor, c1, c2, c3, c4, offset_tangent, vertexTangents, i, vn, offset_normal, vertexNormals, faceNormal, uvi, offset_uv, fi, uv, uv2i, offset_uv2, uv2, vertexIndex, offset_face, offset_line, il, offset_custom, offset_customSrc, value;
      ...
      if (dirtyMorphTargets) {
        ...
        for (t1 = !!J.getInterceptor(material).$isMorphing, n1 = null, n2 = null, n3 = null, n4 = null, vk = 0, vka = null, nka = null, chf = null, faceVertexNormals = null; vk < vkl; ++vk) {
          fl = chunk_faces3.length;
          for (f = 0, offset_morphTarget = 0; f < fl; ++f) {
            ...
            if (t1 && material.morphNormals) {
              t3 = morphNormals.length;
              t9 = morphNormals[vk];
              if (needsSmoothNormals) {
                if (vk >= t3)
                  return H.ioore(morphNormals, vk);
                t3 = t9.get$vertexNormals();
                if (chf >= t3.length)
                ...
                if (vk >= t3)
                  return H.ioore(morphNormals, vk);
                n1 = t9.get$faceNormals().$index(0, chf);
                n3 = n1;
                n2 = n3;
              }
          ...
          for (f = 0; f < fl; ++f) {
            ...
            if (t1 && material.morphNormals) {
              ...
              if (needsSmoothNormals) {
                ...
                if (vk >= t3)
                  return H.ioore(morphNormals, vk);
                n1 = t12.get$faceNormals().$index(0, chf);
                n4 = n1;
                n3 = n4;
                n2 = n3;
              }
      ...
      if (obj_skinWeights.length !== 0) {
        ...
        for (f = 0, offset_skin = 0; f < fl; ++f) {
          ...
          if (t2 >>> 0 !== t2 || t2 >= obj_skinWeights.length)
            return H.ioore(obj_skinWeights, t2);
          ...
          t2 = J.getInterceptor$x(sw1);
          t3 = t2.get$x(sw1);
          t4 = skinWeightArray.length;
          if (offset_skin >= t4)
          ...
          t2 = t2.get$z(sw1);
          if (t5 >= t4)
            return H.ioore(skinWeightArray, t5);
          skinWeightArray[t5] = t2;
          t2 = offset_skin + 3;
          t6 = sw1.get$w();
          if (t2 >= t4)
            return H.ioore(skinWeightArray, t2);
          skinWeightArray[t2] = t6;
          t6 = offset_skin + 4;
          t7 = J.getInterceptor$x(sw2);
          t8 = t7.get$x(sw2);
          if (t6 >= t4)
            return H.ioore(skinWeightArray, t6);
          skinWeightArray[t6] = t8;
          t8 = offset_skin + 5;
          t9 = t7.get$y(sw2);
          if (t8 >= t4)
          ...
          skinWeightArray[t9] = t7;
          t7 = offset_skin + 7;
          t10 = sw2.get$w();
          if (t7 >= t4)
            return H.ioore(skinWeightArray, t7);
          skinWeightArray[t7] = t10;
          t10 = offset_skin + 8;
          t11 = J.getInterceptor$x(sw3);
          t12 = t11.get$x(sw3);
          if (t10 >= t4)
            return H.ioore(skinWeightArray, t10);
          skinWeightArray[t10] = t12;
          t12 = offset_skin + 9;
          t13 = t11.get$y(sw3);
          if (t12 >= t4)
          ...
          skinWeightArray[t13] = t11;
          t11 = offset_skin + 11;
          t14 = sw3.get$w();
          if (t11 >= t4)
            return H.ioore(skinWeightArray, t11);
          skinWeightArray[t11] = t14;
          t14 = t1.get$a(face);
          if (t14 >>> 0 !== t14 || t14 >= obj_skinIndices.length)
            return H.ioore(obj_skinIndices, t14);
          si1 = obj_skinIndices[t14];
          t14 = t1.get$b(face);
          if (t14 >>> 0 !== t14 || t14 >= obj_skinIndices.length)
            return H.ioore(obj_skinIndices, t14);
          si2 = obj_skinIndices[t14];
          t1 = t1.get$c(face);
          if (t1 >>> 0 !== t1 || t1 >= obj_skinIndices.length)
            return H.ioore(obj_skinIndices, t1);
          si3 = obj_skinIndices[t1];
          t1 = J.getInterceptor$x(si1);
          t14 = t1.get$x(si1);
          t4 = skinIndexArray.length;
          if (offset_skin >= t4)
            return H.ioore(skinIndexArray, offset_skin);
          skinIndexArray[offset_skin] = t14;
          t14 = t1.get$y(si1);
          if (t3 >= t4)
            return H.ioore(skinIndexArray, t3);
          skinIndexArray[t3] = t14;
          t1 = t1.get$z(si1);
          if (t5 >= t4)
            return H.ioore(skinIndexArray, t5);
          skinIndexArray[t5] = t1;
          t1 = si1.get$w();
          if (t2 >= t4)
            return H.ioore(skinIndexArray, t2);
          skinIndexArray[t2] = t1;
          t1 = J.getInterceptor$x(si2);
          t2 = t1.get$x(si2);
          if (t6 >= t4)
        ...
        for (f = 0; f < fl; ++f) {
          ...
          skinWeightArray[t17] = t15;
          t15 = offset_skin + 15;
          t18 = sw4.get$w();
          if (t15 >= t4)
            return H.ioore(skinWeightArray, t15);
          skinWeightArray[t15] = t18;
          t18 = t1.get$a(face);
          if (t18 >>> 0 !== t18 || t18 >= obj_skinIndices.length)
            return H.ioore(obj_skinIndices, t18);
          si1 = obj_skinIndices[t18];
          t18 = t1.get$b(face);
          if (t18 >>> 0 !== t18 || t18 >= obj_skinIndices.length)
            return H.ioore(obj_skinIndices, t18);
          si2 = obj_skinIndices[t18];
          t18 = t1.get$c(face);
          if (t18 >>> 0 !== t18 || t18 >= obj_skinIndices.length)
            return H.ioore(obj_skinIndices, t18);
          si3 = obj_skinIndices[t18];
          t1 = t1.get$d(face);
          if (t1 >>> 0 !== t1 || t1 >= obj_skinIndices.length)
            return H.ioore(obj_skinIndices, t1);
          si4 = obj_skinIndices[t1];
          t1 = J.getInterceptor$x(si1);
          t18 = t1.get$x(si1);
          t4 = skinIndexArray.length;
          if (offset_skin >= t4)
            return H.ioore(skinIndexArray, offset_skin);
          skinIndexArray[offset_skin] = t18;
          t18 = t1.get$y(si1);
          if (t3 >= t4)
            return H.ioore(skinIndexArray, t3);
          skinIndexArray[t3] = t18;
          t1 = t1.get$z(si1);
          if (t5 >= t4)
            return H.ioore(skinIndexArray, t5);
          skinIndexArray[t5] = t1;
      ...
      if (dirtyColors && material.vertexColors !== 0) {
        ...
        for (f = 0, offset_color = 0; f < fl; ++f) {
          ...
          t1 = J.getInterceptor$asx(vertexColors);
          if (t1.get$length(vertexColors) === 3 && material.vertexColors === 2) {
            c1 = t1.$index(vertexColors, 0);
            c2 = t1.$index(vertexColors, 1);
            c3 = t1.$index(vertexColors, 2);
          } else {
            c3 = faceColor;
            c2 = c3;
            c1 = c2;
        ...
        for (f = 0; f < fl; ++f) {
          ...
          faceColor = J.get$color$x(face);
          t1 = J.getInterceptor$asx(vertexColors);
          if (t1.get$length(vertexColors) === 4 && material.vertexColors === 2) {
            c1 = t1.$index(vertexColors, 0);
            c2 = t1.$index(vertexColors, 1);
            c3 = t1.$index(vertexColors, 2);
            c4 = t1.$index(vertexColors, 3);
          } else {
            c4 = faceColor;
            c3 = c4;
            c2 = c3;
      ...
      if (dirtyUvs && obj_uvs.length !== 0 && uvType) {
        ...
        for (f = 0, uvi = null, offset_uv = 0; f < fl; ++f) {
          ...
          if (uv == null)
            continue;
          for (t1 = J.getInterceptor$asx(uv), i = 0; i < 3; ++i) {
            uvi = t1.$index(uv, i);
            t2 = uvi.get$u();
            t3 = uvArray.length;
        ...
        for (f = 0; f < fl; ++f) {
          ...
          if (uv == null)
            continue;
          for (t1 = J.getInterceptor$asx(uv), i = 0; i < 4; ++i) {
            uvi = t1.$index(uv, i);
            t2 = uvi.get$u();
            t3 = uvArray.length;
            if (offset_uv < 0 || offset_uv >= t3)
    ...
    renderBuffer$6: function(camera, lights, fog, material, geometryGroup, object) {
      var t1, program, attributes, t2, wireframeBit, geometryGroupHash, updateBuffers, t3, il, i, attribute, t4, primitives;
      t1 = J.getInterceptor$x(material);
      if (!t1.get$visible(material))
        return;
      ...
      if (!!t1.$isMorphing)
        ...
        t3 = true;
      if (t3 && J.$ge$n(attributes.$index(0, "position"), 0)) {
        if (updateBuffers) {
          J.bindBuffer$2$x(this._gl, 34962, geometryGroup.get$__webglVertexBuffer());
      ...
      } else if (!!J.getInterceptor(object).$isMesh && object.morphTargetBase !== 0)
      ...
      if (updateBuffers) {
        if (geometryGroup.get$__webglCustomAttributesList() != null) {
          ...
          for (i = 0; i < il; ++i) {
            ...
            if (J.$ge$n(attributes.$index(0, t3.get$buffer(attribute).get$belongsToAttribute()), 0)) {
              t3.get$buffer(attribute).bind$1(34962);
              this.enableAttribute$1(attributes.$index(0, t3.get$buffer(attribute).get$belongsToAttribute()));
              J.vertexAttribPointer$6$x(this._gl, attributes.$index(0, t3.get$buffer(attribute).get$belongsToAttribute()), t3.get$size(attribute), 5126, false, 0, 0);
            }
          }
        }
        ...
        if (!!t1.$isSkinning && material.get$skinning() && J.$ge$n(attributes.$index(0, "skinIndex"), 0) && J.$ge$n(attributes.$index(0, "skinWeight"), 0)) {
          J.bindBuffer$2$x(this._gl, 34962, geometryGroup.get$__webglSkinIndicesBuffer());
    ...
    setupMorphTargets$3: function(material, geometryGroup, object) {
      ...
      attributes = material.get$_program().attributes;
      if (object.morphTargetBase !== -1 && J.$ge$n(attributes.$index(0, "position"), 0)) {
        t1 = this._gl;
      ...
      t1 = !!J.getInterceptor(material).$isMorphing;
      if (t1)
      ...
      t2 = activeInfluenceIndices.length;
      H.interceptedTypeCast(material, "$isMorphing");
      if (t2 > material.get$numSupportedMorphTargets()) {
        t2 = this.get$numericalSort();
        H.IterableMixinWorkaround_sortList(activeInfluenceIndices, t2);
      ...
      if (t1)
        for (influenceIndex = null, m = 0; m < material.get$numSupportedMorphTargets();) {
          ...
          if (t2) {
            ...
            t2 = C.JSInt_methods.toDouble$0(influences[influenceIndex]);
            if (m >= t1.length)
              return H.ioore(t1, m);
            t1[m] = t2;
          } else {
      ...
      if (material.get$_program().uniforms.$index(0, "morphTargetInfluences") != null)
        J.uniform1fv$2$x(this._gl, material.get$_program().uniforms.$index(0, "morphTargetInfluences"), object.__webglMorphTargetInfluences);
    },
    ...
    _render$4$forceClear$renderTarget: function(scene, camera, forceClear, renderTarget) {
      ...
      for (t2 = this.sortObjects, i = 0; i < il; ++i) {
        ...
        object = webglObject.get$object();
        webglObject.set$render(false);
        t3 = J.getInterceptor$x(object);
        if (t3.get$visible(object))
          if (!(!!t3.$isMesh || false) || !object.get$frustumCulled() || t1.contains$1(0, object)) {
            object.set$_modelViewMatrix(camera.get$matrixWorldInverse().$mul(0, object.get$matrixWorld()));
            object.set$_normalMatrix(S.calcInverse(object.get$_modelViewMatrix()));
            object.get$_normalMatrix().transpose$0();
            object0 = webglObject.get$object();
            t3 = J.getInterceptor$x(webglObject);
            t3.get$buffer(webglObject);
            meshMaterial = object0.get$material();
            if (meshMaterial != null)
              if (meshMaterial.transparent != null) {
            ...
            if (t2) {
              ...
              t3.set$z(webglObject, this._vector3.storage[2]);
            }
          }
      }
      if (t2) {
        t1 = this.get$painterSort();
        renderList.toString;
        if (typeof renderList !== "object" || renderList === null || !!renderList.immutable$list)
          H.throwExpression(P.UnsupportedError$("sort"));
        H.IterableMixinWorkaround_sortList(renderList, t1);
      }
      renderList = scene.get$__webglObjectsImmediate();
      il = renderList.length;
      for (i = 0; i < il; ++i) {
        ...
        webglObject = renderList[i];
        object = webglObject.get$object();
        if (J.get$visible$x(object)) {
          object.set$_modelViewMatrix(camera.get$matrixWorldInverse().$mul(0, object.get$matrixWorld()));
          object.set$_normalMatrix(S.calcInverse(object.get$_modelViewMatrix()));
          object.get$_normalMatrix().transpose$0();
          material = webglObject.get$object().get$material();
      ...
      this.renderObjects$8(scene.get$__webglObjects(), true, "opaque", camera, lights, fog, false, null);
      this.renderObjectsImmediate$7(scene.get$__webglObjectsImmediate(), "opaque", camera, lights, fog, false, null);
      this.renderObjects$8(scene.get$__webglObjects(), false, "transparent", camera, lights, fog, true, null);
      this.renderObjectsImmediate$7(scene.get$__webglObjectsImmediate(), "transparent", camera, lights, fog, true, null);
    ...
    renderObjects$8: function(renderList, reverse, materialType, camera, lights, fog, useBlending, overrideMaterial) {
      ...
      for (t1 = materialType === "opaque", i = start, object = null, buffer = null, material = null; i !== end; i += delta) {
        ...
        if (webglObject.get$render() === true) {
          object = webglObject.get$object();
          buffer = J.get$buffer$x(webglObject);
          material = t1 ? webglObject.get$opaque() : webglObject.get$transparent();
          if (material == null)
            continue;
          if (useBlending)
    ...
    renderObjectsImmediate$7: function(renderList, materialType, camera, lights, fog, useBlending, overrideMaterial) {
      var il, material, i, webglObject, object, t1;
      il = renderList.length;
      for (material = null, i = 0; i < il; ++i) {
        ...
        if (J.get$visible$x(object)) {
          ...
          if (useBlending)
            this.setBlending$4(material.get$blending(), J.get$blendEquation$x(material), material.get$blendSrc(), material.get$blendDst());
          this.setDepthTest$1(material.get$depthTest());
          t1 = material.get$depthWrite();
          if (this._oldDepthWrite !== t1) {
            J.depthMask$1$x(this._gl, t1);
            this._oldDepthWrite = t1;
          }
          this.setPolygonOffset$3(J.get$polygonOffset$x(material), material.get$polygonOffsetFactor(), material.get$polygonOffsetUnits());
    ...
    sortFacesByMaterial$2: function(geometry, material) {
      var hash_map, numMorphTargets, numMorphNormals, fl, f, t1, face, groupHash, t2, vertices, t3;
      hash_map = P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      numMorphTargets = geometry.morphTargets.length;
      numMorphNormals = geometry.morphNormals.length;
      ...
      for (f = 0; f < fl; ++f) {
        ...
        if (geometry.get$geometryGroups().$index(0, groupHash) == null) {
          ...
          t2.three$WebGLGeometry$numMorphTargets = numMorphTargets;
          t2.three$WebGLGeometry$numMorphNormals = numMorphNormals;
          t1.$indexSet(0, groupHash, t2);
        }
        t1 = J.getInterceptor$x(face);
        vertices = t1.get$size(face);
        t2 = geometry.get$geometryGroups().$index(0, groupHash).three$WebGLGeometry$verticesCount;
        if (typeof t2 !== "number")
          return t2.$add();
        if (typeof vertices !== "number")
          return H.iae(vertices);
        if (t2 + vertices > 65535) {
          t2 = hash_map.$index(0, "0");
          t3 = J.getInterceptor$asx(t2);
          t3.$indexSet(t2, "counter", J.$add$ns(t3.$index(t2, "counter"), 1));
          groupHash = H.S(J.$index$asx(hash_map.$index(0, "0"), "hash")) + "_" + H.S(J.$index$asx(hash_map.$index(0, "0"), "counter"));
          if (geometry.get$geometryGroups().$index(0, groupHash) == null) {
            t2 = geometry.get$geometryGroups();
            t3 = new S.WebGLGeometry(null, null, null, null, null, null, 0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, false, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
            t3.three$WebGLGeometry$faces3 = [];
            t3.three$WebGLGeometry$faces4 = [];
            t3.three$WebGLGeometry$materialIndex = H.Primitives_parseInt("0", null, null);
            t3.three$WebGLGeometry$verticesCount = 0;
            t3.three$WebGLGeometry$numMorphTargets = numMorphTargets;
            t3.three$WebGLGeometry$numMorphNormals = numMorphNormals;
            t2.$indexSet(0, groupHash, t3);
          }
        }
        if (t1.get$size(face) === 3)
          geometry.get$geometryGroups().$index(0, groupHash).three$WebGLGeometry$faces3.push(f);
        else
          geometry.get$geometryGroups().$index(0, groupHash).three$WebGLGeometry$faces4.push(f);
        t1 = geometry.get$geometryGroups().$index(0, groupHash);
        t2 = t1.three$WebGLGeometry$verticesCount;
        if (typeof t2 !== "number")
          return t2.$add();
        t1.three$WebGLGeometry$verticesCount = t2 + vertices;
      }
    ...
    initWebGLObjects$1: function(scene) {
      var t1, t2, ol, o;
      if (scene.get$__webglObjects() == null) {
        scene.set$__webglObjects([]);
        scene.set$__webglObjectsImmediate([]);
        scene.set$__webglSprites([]);
        scene.set$__webglFlares([]);
      }
      for (; scene.get$__objectsAdded().length > 0;) {
        t1 = scene.get$__objectsAdded();
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        this.addObject$2(t1[0], scene);
        C.JSArray_methods.removeAt$1(scene.get$__objectsAdded(), 0);
      }
      for (; scene.get$__objectsRemoved().length > 0;) {
        t1 = scene.get$__objectsRemoved();
        if (0 >= t1.length)
          return H.ioore(t1, 0);
        t1 = t1[0];
        t2 = J.getInterceptor(t1);
        if (!t2.$isMesh)
          ...
          t2 = true;
        if (t2)
          this.removeInstances$2(scene.get$__webglObjects(), t1);
        else
          t1.get$immediateRenderCallback();
        t1.set$__webglActive(false);
        C.JSArray_methods.removeAt$1(scene.get$__objectsRemoved(), 0);
      }
      for (ol = scene.get$__webglObjects().length, o = 0; o < ol; ++o) {
        t1 = scene.get$__webglObjects();
        if (o >= t1.length)
          return H.ioore(t1, o);
        this.updateObject$1(t1[o].get$object());
      }
    },
    addObject$2: function(object, scene) {
      var geometry, t1, material, nvertices;
      geometry = object.get$geometry();
      if (!object.get$__webglInit()) {
        object.set$__webglInit(true);
        t1 = new T.Matrix4(new Float32Array(16));
        t1.setIdentity$0();
        object.set$_modelViewMatrix(t1);
        object.set$_normalMatrix(new T.Matrix3(new Float32Array(9)));
      ...
      if (!object.get$__webglActive()) {
        ...
        if (!!t1.$isMesh)
          ...
          t1 = !!t1.$isLine || false;
          if (t1)
            scene.get$__webglObjects().push(new S.WebGLObject(geometry, object, null, null, true, 0));
          else
            object.get$immediateRenderCallback();
        }
        object.set$__webglActive(true);
      }
    },
    updateObject$1: function(object) {
      var geometry, t1, il, i, t2, geometryGroup, material;
      geometry = object.get$geometry();
      t1 = J.getInterceptor(object);
      if (!!t1.$isMesh) {
    ...
    removeInstances$2: function(objlist, object) {
      ...
      for (o = objlist.length - 1; o >= 0; --o) {
        ...
        t1 = objlist[o].get$object();
        if (t1 == null ? object == null : t1 === object)
          C.JSArray_methods.removeAt$1(objlist, o);
      }
    },
    initMaterial$4: function(material, lights, fog, object) {
      var t1, shaderID, maxLightCount, maxShadows, maxBones, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, attributes, i;
      ...
      if (shaderID != null) {
        ...
        material.set$_uniforms(S.UniformsUtils_clone(t1.$index(0, "uniforms")));
        material.set$_vertexShader(t1.$index(0, "vertexShader"));
        material.set$_fragmentShader(t1.$index(0, "fragmentShader"));
      }
      maxLightCount = this.allocateLights$1(lights);
      maxShadows = this.allocateShadows$1(lights);
      maxBones = this.allocateBones$1(object);
      t1 = material.get$_fragmentShader();
      t2 = material.get$_vertexShader();
      t3 = material.get$_uniforms();
      t4 = J.getInterceptor(material);
      t5 = !!t4.$isShaderMaterial;
      t6 = t5 ? material.attributes : P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      t5 = t5 ? material.defines : P.LinkedHashMap_LinkedHashMap$_empty(null, null);
      t7 = !!t4.$isTextureMapping ? t4.get$map(material) : null;
      t8 = !!t4.$isEnvironmentMapping;
      t9 = t8 ? material.get$envMap() : null;
      t10 = t8 ? material.get$lightMap() : null;
      t8 = t8 ? material.get$specularMap() : null;
      t11 = material.get$vertexColors();
      t12 = material.get$fog();
      t13 = !!t4.$isSkinning && material.get$skinning();
      ...
      if (t15)
        ;
      t4 = !!t4.$isMorphing;
      t15 = t4 && material.get$morphTargets();
      t16 = t4 && material.get$morphNormals();
      ...
      t23 = this.shadowMapEnabled && object.get$receiveShadow();
      t24 = material.get$alphaTest();
      material.set$_program(this.buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround(shaderID, t1, t2, t3, t6, t5, t24, 0, 0, null, material.get$side() === 2, t9, material.get$side() === 1, fog, false, t10, t7, maxBones, t19, t22, t18, t17, t20, maxShadows, t21, false, t16, t15, null, false, this.shadowMapCascade, this.shadowMapDebug, t23, this.shadowMapType, false, t13, t8, t12, t14, t11, false));
      attributes = material.get$_program().attributes;
      if (t4 && material.get$morphTargets()) {
        H.interceptedTypeCast(material, "$isMorphing");
      ...
      if (t4 && material.get$morphNormals()) {
        H.interceptedTypeCast(material, "$isMorphing");
      ...
      material.set$_uniformsList([]);
      material.get$_uniforms().forEach$1(0, new S.WebGLRenderer_initMaterial_closure(material));
    },
    setProgram$5: function(camera, lights, fog, material, object) {
      ...
      program = material.get$_program();
      p_uniforms = program.uniforms;
      m_uniforms = material.get$_uniforms();
      ...
      if (refreshMaterial) {
        ...
        this.loadUniformsGeneric$2(program, material.get$_uniformsList());
    ...
    refreshUniformsShadow$2: function(uniforms, lights) {
      ...
      if (uniforms.containsKey$1(0, "shadowMatrix"))
        for (t1 = J.getInterceptor$asx(lights), il = t1.get$length(lights), j = 0, i = 0; i < il; ++i) {
          ...
          if (!light.get$castShadow())
            continue;
          t2 = !!J.getInterceptor(light).$isDirectionalLight && !light.shadowCascade;
          if (t2) {
            j0 = j + 1;
    ...
    loadUniformsGeneric$2: function(program, uniforms) {
      ...
      for (uniform = null, value = null, type = null, texture = null, textureUnit = null, i = null, il = null, j = 0; j < jl; ++j) {
        ...
        if (type === "i")
          ...
          if (texture == null)
            continue;
          if (!!J.getInterceptor(texture.get$image()).$isList && texture.get$image()._images.length === 6)
    ...
    setupLights$2: function(program, lights) {
      ...
      for (t2 = this.gammaInput, t3 = J.getInterceptor$asx(dirColors), t4 = J.getInterceptor$asx(dirPositions), l = 0, r = 0, g = 0, b = 0, color = null, skyColor = null, groundColor = null, intensity = null, intensitySq = null, position = null, distance = null, dirLength = 0, pointLength = 0, spotLength = 0, hemiLength = 0, dirCount = 0, pointCount = 0, spotCount = 0, hemiCount = 0, dirOffset = 0, pointOffset = 0, spotOffset = 0, hemiOffset = 0; l < ll; ++l) {
        ...
        t6 = !!t5.$isDirectionalLight;
        t7 = !t6;
        if ((!t7 || false) && light.get$onlyShadow() || t5.get$visible(light) !== true)
          continue;
        ...
        if (t6) {
          ...
          t5 = light.target.matrixWorld.getTranslation$0();
          this._vector3 = t5;
          this._direction.sub$1(t5);
    ...
    buildProgram$41$alphaTest$boneTextureHeight$boneTextureWidth$bumpMap$doubleSided$envMap$flipSided$fog$fogExp$lightMap$map$maxBones$maxDirLights$maxHemiLights$maxMorphNormals$maxMorphTargets$maxPointLights$maxShadows$maxSpotLights$metal$morphNormals$morphTargets$normalMap$perPixel$shadowMapCascade$shadowMapDebug$shadowMapEnabled$shadowMapType$sizeAttenuation$skinning$specularMap$useFog$useVertexTexture$vertexColors$wrapAround: function(shaderID, fragmentShader, vertexShader, uniforms, attributes, defines, alphaTest, boneTextureHeight, boneTextureWidth, bumpMap, doubleSided, envMap, flipSided, fog, fogExp, lightMap, map, maxBones, maxDirLights, maxHemiLights, maxMorphNormals, maxMorphTargets, maxPointLights, maxShadows, maxSpotLights, metal, morphNormals, morphTargets, normalMap, perPixel, shadowMapCascade, shadowMapDebug, shadowMapEnabled, shadowMapType, sizeAttenuation, skinning, specularMap, useFog, useVertexTexture, vertexColors, wrapAround) {
      ...
      t16 = typeof vertexColors === "number" && Math.floor(vertexColors) === vertexColors && vertexColors !== 0;
      t16 = t16 ? "#define USE_COLOR" : "";
      ...
      if (t12)
        ;
      t12 = typeof vertexColors === "number" && Math.floor(vertexColors) === vertexColors && vertexColors !== 0;
      t12 = t12 ? "#define USE_COLOR" : "";
      ...
      glFragmentShader = this.getShader$2("fragment", C.JSArray_methods.join$1([t2, "", customDefines, "", t3, t5, t7, t9, t10, t11, t4, t6, t8, t13, "", "", "", "", "", "", "", t12, t14, t15, t16, t17, t18, t19, t20, t21, shadowMapCascade ? "#define SHADOWMAP_CASCADE" : "", "uniform mat4 viewMatrix;", "uniform vec3 cameraPosition;", ""], "\n") + H.S(fragmentShader));
    ...
    setTexture$2: function(texture, slot) {
      var t1, t2, image, glFormat, glType, mipmaps, i, mipmap;
    ...
    clampToMaxSize$2: function(image, maxSize) {
      ...
      newWidth = J.floor$0$n(J.$div$n(J.$mul$ns(t1.get$width(image), maxSize), maxDimension));
      newHeight = J.floor$0$n(J.$div$n(J.$mul$ns(t1.get$height(image), maxSize), maxDimension));
    ...
    setCubeTexture$2: function(texture, slot) {
      var t1, t2, cubeImage, i, t3, image, t4, isImagePowerOfTwo, glFormat, glType;
      if (texture.get$image()._images.length === 6) {
        if (!!J.getInterceptor(texture.get$image()).$isImageList) {
          ...
          t1 = Array(t1);
          t1.fixed$length = init;
          t1.$builtinTypeInfo = [W.ImageElement];
          texture.set$image(new S.ImageList(null, t1, t2, null));
        }
        if (texture.get$needsUpdate()) {
          if (texture.get$image().webglTextureCube == null) {
            texture.get$image().webglTextureCube = J.createTexture$0$x(this._gl);
            ++this.info.memory.textures;
          }
          J.activeTexture$1$x(this._gl, 33984 + slot);
          J.bindTexture$2$x(this._gl, 34067, texture.get$image().webglTextureCube);
          t1 = this._gl;
          t2 = J.getInterceptor$x(texture);
          J.pixelStorei$2$x(t1, 37440, t2.get$flipY(texture) === true ? 1 : 0);
          cubeImage = Array(6);
          for (t1 = this.autoScaleCubemaps, i = 0; i < 6; ++i)
            if (t1 && true) {
              t3 = texture.get$image()._images;
              if (i >= t3.length)
                return H.ioore(t3, i);
              cubeImage[i] = this.clampToMaxSize$2(t3[i], this.maxCubemapSize);
            } else {
              t3 = texture.get$image()._images;
              if (i >= t3.length)
                return H.ioore(t3, i);
          ...
          image = cubeImage[0];
          t1 = J.getInterceptor$x(image);
          t3 = t1.get$width(image);
          t4 = J.getInterceptor$n(t3);
          if (t4.$and(t3, t4.$sub(t3, 1)) === 0) {
            t1 = t1.get$height(image);
            t3 = J.getInterceptor$n(t1);
            isImagePowerOfTwo = t3.$and(t1, t3.$sub(t1, 1)) === 0;
          } else
            isImagePowerOfTwo = false;
          glFormat = this.paramThreeToGL$1(t2.get$format(texture));
          glType = this.paramThreeToGL$1(t2.get$type(texture));
          this.setTextureParameters$3(34067, texture, isImagePowerOfTwo);
          for (i = 0; i < 6; ++i)
            J.texImage2DImage$6$x(this._gl, 34069 + i, 0, glFormat, glFormat, glType, cubeImage[i]);
    ...
    setupRenderBuffer$2: function(renderbuffer, renderTarget) {
      ...
      if (t1 && !renderTarget.stencilBuffer) {
        ...
        t2 = this._gl;
        if (t1) {
          J.renderbufferStorage$4$x(t2, 36161, 34041, renderTarget.width, renderTarget.height);
          J.framebufferRenderbuffer$4$x(this._gl, 36160, 33306, 36161, renderbuffer);
        } else
          J.renderbufferStorage$4$x(t2, 36161, 32854, renderTarget.width, renderTarget.height);
      }
    },
    ...
    allocateLights$1: function(lights) {
      ...
      for (l = 0, dirLights = 0, pointLights = 0, spotLights = 0, hemiLights = 0; l < ll; ++l) {
        light = t1.$index(lights, l);
        t2 = !!J.getInterceptor(light).$isDirectionalLight;
    ...
    WebGLRenderer$10$alpha$antialias$canvas$clearAlpha$clearColorHex$devicePixelRatio$precision$premultipliedAlpha$preserveDrawingBuffer$stencil: function(alpha, antialias, canvas, clearAlpha, clearColorHex, devicePixelRatio, precision, premultipliedAlpha, preserveDrawingBuffer, stencil) {
      var t1, _vertexShaderPrecisionHighpFloat, _vertexShaderPrecisionMediumpFloat, _fragmentShaderPrecisionHighpFloat, _fragmentShaderPrecisionMediumpFloat, highpAvailable, mediumpAvailable, t2, t3, depthShader, depthUniforms;
      ...
      t1._depthMaterial = S.ShaderMaterial$(0, null, 205, 100, 204, 1, true, true, true, depthShader.$index(0, "fragmentShader"), false, false, false, "", 1, false, false, 0, 0, 2, 0, false, false, depthUniforms, 0, depthShader.$index(0, "vertexShader"), true, false, 1);
      t1._depthMaterialMorph = S.ShaderMaterial$(0, null, 205, 100, 204, 1, true, true, true, depthShader.$index(0, "fragmentShader"), false, false, true, "", 1, false, false, 0, 0, 2, 0, false, false, depthUniforms, 0, depthShader.$index(0, "vertexShader"), true, false, 1);
      t1._depthMaterialSkin = S.ShaderMaterial$(0, null, 205, 100, 204, 1, true, true, true, depthShader.$index(0, "fragmentShader"), false, false, false, "", 1, false, false, 0, 0, 2, 0, true, false, depthUniforms, 0, depthShader.$index(0, "vertexShader"), true, false, 1);
      t2 = S.ShaderMaterial$(0, null, 205, 100, 204, 1, true, true, true, depthShader.$index(0, "fragmentShader"), false, false, true, "", 1, false, false, 0, 0, 2, 0, true, false, depthUniforms, 0, depthShader.$index(0, "vertexShader"), true, false, 1);
      t1._depthMaterialMorphSkin = t2;
      t1._depthMaterial.shadowPass = true;
      t1._depthMaterialMorph.shadowPass = true;
      t1._depthMaterialSkin.shadowPass = true;
      t2.shadowPass = true;
  ...
  WebGLRenderer_initCustomAttributes_closure: {
    "^": "Closure:43;this_0,geometry_1,nvertices_2",
  ...
  WebGLRenderer_initMeshBuffers_closure: {
    "^": "Closure:43;this_0,geometryGroup_1,nvertices_2",
    call$2: function(key, attribute) {
  ...
  WebGLRenderer_renderPlugins_closure: {
    "^": "Closure:29;this_0,scene_1,camera_2",
  ...
  WebGLRenderer_addObject_closure: {
    "^": "Closure:43;this_0,object_1,geometry_2",
  ...
  WebGLRenderer_addObject_closure0: {
    "^": "Closure:43;this_3,object_4,scene_5",
    call$2: function(k, geometryGroup) {
      this.scene_5.get$__webglObjects().push(new S.WebGLObject(geometryGroup, this.object_4, null, null, true, 0));
    },
    $isFunction: true
  },
  WebGLRenderer_initMaterial_closure: {
    "^": "Closure:43;material_0",
    call$2: function(k, u) {
      return this.material_0.get$_uniformsList().push([u, k]);
    },
    $isFunction: true
  },
  ...
  WebGLGeometry: {
    "^": "Object;id:three$WebGLGeometry$id*,three$WebGLGeometry$verticesCount,faces3:three$WebGLGeometry$faces3<,faces4:three$WebGLGeometry$faces4<,numMorphTargets:three$WebGLGeometry$numMorphTargets<,numMorphNormals:three$WebGLGeometry$numMorphNormals<,three$WebGLGeometry$materialIndex,geometryGroups:three$WebGLGeometry$geometryGroups@,geometryGroupsList:three$WebGLGeometry$geometryGroupsList@,__webglVertexBuffer:three$WebGLGeometry$__webglVertexBuffer@,__webglNormalBuffer:three$WebGLGeometry$__webglNormalBuffer@,__webglTangentBuffer:three$WebGLGeometry$__webglTangentBuffer@,__webglColorBuffer:three$WebGLGeometry$__webglColorBuffer@,__webglLineDistanceBuffer:three$WebGLGeometry$__webglLineDistanceBuffer@,__webglUVBuffer:three$WebGLGeometry$__webglUVBuffer@,__webglUV2Buffer:three$WebGLGeometry$__webglUV2Buffer@,three$WebGLGeometry$__webglSkinVertexABuffer,three$WebGLGeometry$__webglSkinVertexBBuffer,__webglSkinIndicesBuffer:three$WebGLGeometry$__webglSkinIndicesBuffer@,__webglSkinWeightsBuffer:three$WebGLGeometry$__webglSkinWeightsBuffer@,__webglFaceBuffer:three$WebGLGeometry$__webglFaceBuffer@,__webglLineBuffer:three$WebGLGeometry$__webglLineBuffer@,__webglMorphTargetsBuffers:three$WebGLGeometry$__webglMorphTargetsBuffers@,__webglMorphNormalsBuffers:three$WebGLGeometry$__webglMorphNormalsBuffers@,__webglInit:three$WebGLGeometry$__webglInit@,__inittedArrays:three$WebGLGeometry$__inittedArrays@,__vertexArray:three$WebGLGeometry$__vertexArray@,__normalArray:three$WebGLGeometry$__normalArray@,__tangentArray:three$WebGLGeometry$__tangentArray@,__colorArray:three$WebGLGeometry$__colorArray@,__lineDistanceArray:three$WebGLGeometry$__lineDistanceArray@,__uvArray:three$WebGLGeometry$__uvArray@,__uv2Array:three$WebGLGeometry$__uv2Array@,three$WebGLGeometry$__skinVertexAArray,three$WebGLGeometry$__skinVertexBArray,__skinIndexArray:three$WebGLGeometry$__skinIndexArray@,__skinWeightArray:three$WebGLGeometry$__skinWeightArray@,__faceArray:three$WebGLGeometry$__faceArray@,__lineArray:three$WebGLGeometry$__lineArray@,__morphTargetsArrays:three$WebGLGeometry$__morphTargetsArrays@,__morphNormalsArrays:three$WebGLGeometry$__morphNormalsArrays@,__webglFaceCount:three$WebGLGeometry$__webglFaceCount@,__webglLineCount:three$WebGLGeometry$__webglLineCount@,three$WebGLGeometry$__webglParticleCount,three$WebGLGeometry$__webglVertexCount,three$WebGLGeometry$__sortArray,__webglCustomAttributesList:three$WebGLGeometry$__webglCustomAttributesList<"
  },
  WebGLObject: {
  ...
  Scene: {
    ...
    addObject$1: function(object) {
      ...
      for (c = 0; c < t1.get$children(object).length; ++c) {
        t2 = t1.get$children(object);
        if (c >= t2.length)
          return H.ioore(t2, c);
        this.addObject$1(t2[c]);
      }
    },
  ...
  ImageList: {
    "^": "Object_ListMixin;loadCount,_images,props,webglTextureCube",
    $index: function(_, index) {
      var t1 = this._images;
    ...
    set$length: function(_, size) {
      C.JSArray_methods.set$length(this._images, size);
    },
    $isImageList: true
  },
  Object_ListMixin: {
...
["vector_math", "package:vector_math/vector_math.dart", , T, {
  ...
  Quaternion: {
    ...
    $mul: function(_, other) {
      ...
      _y = t1[1];
      _x = t1[0];
      ow = other.get$storage().$index(0, 3);
      oz = other.get$storage().$index(0, 2);
      oy = other.get$storage().$index(0, 1);
      ox = other.get$storage().$index(0, 0);
...
//# sourceMappingURL=sinwave.dart.js.map
